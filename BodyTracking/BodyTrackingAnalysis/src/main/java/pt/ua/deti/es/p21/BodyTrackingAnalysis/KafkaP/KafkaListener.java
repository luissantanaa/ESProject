...
public class KafkaListener {
    ...
    public void consumeJointReadings(JSONObject jsonO) throws IOException{
        ...
        }else if(Float.parseFloat(joints_divided[24].split(";")[1]) < Float.parseFloat(joints_divided[3].split(";")[1]) && Float.parseFloat(joints_divided[22].split(";")[1]) < Float.parseFloat(joints_divided[3].split(";")[1]) ){
            producer.sendMessage("1");
        }else if (Float.parseFloat(joints_divided[24].split(";")[1]) < Float.parseFloat(joints_divided[3].split(";")[1])){
            producer.sendMessage("2");
            System.out.print("ARM UP");
        }else if (Float.parseFloat(joints_divided[22].split(";")[1]) < Float.parseFloat(joints_divided[3].split(";")[1])){
            producer.sendMessage("3");
            System.out.print("ARM UP");
        }else if(Float.parseFloat(joints_divided[23].split(";")[19]) < Float.parseFloat(joints_divided[3].split(";")[1]) &&Float.parseFloat(joints_divided[15].split(";")[1]) < Float.parseFloat(joints_divided[3].split(";")[1])){
