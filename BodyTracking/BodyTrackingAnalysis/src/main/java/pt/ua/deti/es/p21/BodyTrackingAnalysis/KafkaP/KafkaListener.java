...
public class KafkaListener {
    ...
    public void consumeJointReadings(JSONObject jsonO) throws IOException{
        ...
        }else if(Integer.parseInt(joints_divided[14].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1]) && Integer.parseInt(joints_divided[13].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1]) ){
            producer.sendMessage("1");
        }else if (Integer.parseInt(joints_divided[14].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1])){
            producer.sendMessage("2");
        }else if (Integer.parseInt(joints_divided[13].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1])){
            producer.sendMessage("3");
        }else if(Integer.parseInt(joints_divided[23].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1]) &&Integer.parseInt(joints_divided[24].split(";")[1]) < Integer.parseInt(joints_divided[0].split(";")[1])){
