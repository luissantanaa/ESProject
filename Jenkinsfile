    ...
    stages {
        ...
        stage('Clean BT') {
            ...
            steps {
                ...
                sh "cd BodyTracking/BodyTracking/ && mvn clean"
            ...
            steps {
                ...
                sshagent (credentials: ['RuntimeVMCredP21']) {
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no esp21@192.168.160.103 docker run -p 21001:8181 -d --name esp21bodytrackingcontainer_as 192.168.160.99:5000/p21/esp21bodytracking_as_build:latest 
                    '''
                }
            ...
            steps {
                ...
                sshagent (credentials: ['RuntimeVMCredP21']) {
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no esp21@192.168.160.103 docker run -p 21000:8080 -d --name esp21bodytrackingcontainer_bt 192.168.160.99:5000/p21/esp21bodytracking_build:latest 
                    '''
                }
